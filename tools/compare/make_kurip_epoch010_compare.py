"""Build comparison montages including kurip epoch010."""
...
IMAGE_SIZE = 480
FIXED_COMPARE_PATH = "results/compare_kurip_epoch010_vs_shape1.png"
KURIP_COMPARE_PATH = "results/compare_kurip_train_epoch010_vs_shape1.png"
FIXED_SAMPLES = [
    "housei_002_06_15",
    "housei_002_07_12",
    "housei_002_19_12",
...
def draw_montage(samples, image_paths, output_path):
    columns = ["rough", "shape1", "kurip_ep010", "kurip_ep020", "line (GT)"]
    header_h = 28
    label_h = 22
    canvas = Image.new(
        "RGB",
    ...
    for row, name in enumerate(samples):
        ...
        for col, path in enumerate(image_paths(name)):
            autocontrast = col == 0
            image = load_image(path, autocontrast=autocontrast)
...
def main():
    draw_montage(
        ...
        lambda name: [
            ...
            f"results/kurip_epoch010/{name}_out.png",
            f"results/kurip/{name}_out.png",
    ...
    draw_montage(
        ...
        lambda name: [
            ...
            f"results/kurip_epoch010_samples/{name}_out.png",
            f"results/kurip_samples/{name}_out.png",
