...
- **目視評価**: 済み(3エポック版・100エポック版・密データ28エポック版・200エポック版とも)
- **montageの場所**: `results/compare_combined_koma_direct_unet_20260801.png`(3エポック)；`results/compare_combined_koma_direct_unet_100ep_20260801.png`(100エポック)；`results/compare_combined_koma_direct_unet_dense_28ep_20260801.png`(密データ28エポック)；`results/compare_combined_koma_direct_unet_200ep_20260801.png`(200エポック)
