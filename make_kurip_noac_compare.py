"""Build comparison montages for the no-autocontrast kurip fine-tune."""
...
IMAGE_SIZE = 480
FIXED_COMPARE_PATH = "results/compare_kurip_noac_vs_shape1.png"
KURIP_COMPARE_PATH = "results/compare_kurip_noac_train_vs_shape1.png"
FIXED_SAMPLES = [
    "housei_002_06_15",
    "housei_002_07_12",
    "housei_002_19_12",
...
def main():
    draw_montage(
        ...
        lambda name: [
            ...
            f"results/kurip_clean540_noac_epoch010/{name}_out.png",
            f"results/kurip_clean540_noac/{name}_out.png",
    ...
    draw_montage(
        ...
        lambda name: [
            ...
            f"results/kurip_clean540_noac_epoch010_samples/{name}_out.png",
            f"results/kurip_clean540_noac_samples/{name}_out.png",
