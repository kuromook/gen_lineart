"""Build comparison montages for the balanced-dense kurip fine-tune."""
...
IMAGE_SIZE = 480
FIXED_COMPARE_PATH = "results/compare_kurip_balanced_dense_vs_shape1.png"
KURIP_COMPARE_PATH = "results/compare_kurip_balanced_dense_train_vs_shape1.png"
FIXED_SAMPLES = [
    "housei_002_06_15",
    "housei_002_07_12",
    "housei_002_19_12",
...
def draw_montage(samples, image_paths, output_path):
    columns = ["rough", "shape1", "clean540", "bd_ep010", "bd_ep020", "line (GT)"]
    header_h = 28
    label_h = 22
    canvas = Image.new(
        "RGB",
...
def main():
    draw_montage(
        ...
        lambda name: [
            ...
            f"results/kurip_balanced_dense_epoch010/{name}_out.png",
            f"results/kurip_balanced_dense/{name}_out.png",
    ...
    draw_montage(
        ...
        lambda name: [
            ...
            f"results/kurip_balanced_dense_epoch010_samples/{name}_out.png",
            f"results/kurip_balanced_dense_samples/{name}_out.png",
