"""Build a fixed-sample comparison montage for the kurip fine-tune."""
...
IMAGE_SIZE = 480
COMPARE_PATH = "results/compare_kurip_vs_shape1.png"
SAMPLES = [
    "housei_002_06_15",
    "housei_002_07_12",
    "housei_002_19_12",
...
def main():
    ...
    for row, name in enumerate(SAMPLES):
        ...
        images = [
            ...
            load_image(f"results/kurip/{name}_out.png"),
