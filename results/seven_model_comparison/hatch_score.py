...
results/six_model_comparison/hatch_score.py with the manga_line rank32
retrain (hypothesis #2). See results/four_model_comparison/hatch_score.py's
docstring for the full rationale: this is orthogonal to
gt_bsds_f1/precision/recall and is the axis that actually tracks "escape
hatch-fill hallucination", the track's current goal.
"""
