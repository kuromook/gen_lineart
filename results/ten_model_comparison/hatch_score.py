...
results/nine_model_comparison/hatch_score.py with the "manga panel"
caption-ablation retrain (hypothesis #5). See
results/four_model_comparison/hatch_score.py's docstring for the full
rationale: this is orthogonal to gt_bsds_f1/precision/recall and is the
axis that actually tracks "escape hatch-fill hallucination", the track's
current goal.
"""
