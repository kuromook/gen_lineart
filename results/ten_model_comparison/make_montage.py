...
COLS = [
    ...
    ("manga_cons", TRACK / "results/controlnet_lora_manga_consistency_20260904_eval" / "{s}_out.png"),
    ("manga_noman", TRACK / "results/controlnet_lora_manga_nomangaword_20260905_eval" / "{s}_out.png"),
]
...
def main():
    ...
    out_path = TRACK / "results/ten_model_comparison/montage.png"
    sheet.save(out_path)
