...
results/five_model_comparison/hatch_score.py with the SDXL manga_line
retrain. See results/four_model_comparison/hatch_score.py's docstring for
the full rationale: this is orthogonal to gt_bsds_f1/precision/recall and
is the axis that actually tracks "escape hatch-fill hallucination", the
