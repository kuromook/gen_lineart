...
COLS = [
    ...
    ("anime_trained", TRACK / "results/preprocessed_cond_check/cs1.00" / "{s}_out.png"),
    ("coarse_trained", TRACK / "results/controlnet_lora_coarse_20260827_eval" / "{s}_out.png"),
]
...
def main():
    ...
    out_path = TRACK / "results/coarse_vs_anime_comparison/montage.png"
    sheet.save(out_path)
